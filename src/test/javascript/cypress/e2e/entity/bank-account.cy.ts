...
describe('BankAccount e2e test', () => {
  ...
  const bankAccountSample = { name: 'explicate poorly dose', balance: 21115.41 };
  ...
  describe('new BankAccount page', () => {
    ...
    it('should create an instance of BankAccount', () => {
      ...
      cy.get(`[data-cy="balance"]`).type('25724.1');
      cy.get(`[data-cy="balance"]`).should('have.value', '25724.1');
