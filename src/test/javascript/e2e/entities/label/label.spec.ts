...
describe('Label e2e test', () => {
    ...
    it('should load Labels', async () => {
        ...
        expect(await labelComponentsPage.getTitle()).toMatch(/Labels/);
    });

    it('should load create Label page', async () => {
        await labelComponentsPage.clickOnCreateButton();
        labelUpdatePage = new LabelUpdatePage();
        expect(await labelUpdatePage.getPageTitle()).toMatch(/Create or edit a Label/);
    ...
    it('should delete last Label', async () => {
        ...
        expect(await labelDeleteDialog.getDialogTitle()).toMatch(/Are you sure you want to delete this Label?/);
